...
\bmQ_\rmf    \hpil \bmC_\rmf  &  \hpil \bmD
\end{cases}
\label{eq:}
\end{equation}
%
...
%
\begin{align}
\Dp{\bmS_i}{t}    &=   -\frac{1}{\Tinf} \bigg(\sum_{j=1}^n R_{ij}(t)\,\bmI_j\bigg) \, \bmS_i 
                        - \frac{q_\rmm R(t)}{\Tinf} \bmQ_\rmm \bmS_i     \label{eq:Si} \\
\Dp{\bmE_i}{t}    &=    \frac{1}{\Tinf} \bigg(\sum_{j=1}^n R_{ij}(t)\,\bmI_j\bigg) \, \bmS_i - \frac{1}{\Tinc}\, \bmE_i  
                        + \frac{q_\rmm R(t)}{\Tinf} \bmQ_\rmm \bmS_i        \label{eq:Ei} \\
...
\Dp{\bmH_\rms}{t} &=    \frac{1}{\Thosp}     \, \bmQ_\rms     - \frac{1}{\Trecs}  \, \bmH_\rms         \label{eq:Shos} \\
\Dp{\bmH_\rmf}{t} &=    \frac{h}{\Thosp}     \, \bmQ_\rmf     - \frac{1}{\Tdeath} \, \bmH_\rmf         \label{eq:Fhos} \\
\Dp{\bmC_\rmf}{t} &=    \frac{(1-h)}{\Thosp} \, \bmQ_\rmf     - \frac{1}{\Tdeath} \, \bmC_\rmf         \label{eq:Fhos} \\
\Dp{\bmR_\rmm }{t}&=    \frac{1}{\Trecm}     \, \bmQ_\rmm                                        \label{eq:Rm} \\
\Dp{\bmR_\rms}{t} &=    \frac{1}{\Trecs}     \, \bmH_\rms                                        \label{eq:E} \\
\Dp{\bmD     }{t} &=    \frac{1}{\Tdeath}    \, \bmH_\rmf   + \frac{1}{\Tdeath} \bmC_\rmf                                     \label{eq:D} 
\end{align}
