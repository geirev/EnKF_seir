...
# Setting file name country counter
   ...
   plot for [i=4:N] "hosp".nn."_1.dat" u 1:i w l ls 3,   "hosp".nn."_1.dat" u 1:2 w l ls 4 title 'Hospitalized', "obsH".nn.".dat" u 2:3 with points ls 9,\
        for [i=4:N] "dead".nn."_1.dat" u 1:i w l ls 1,   "dead".nn."_1.dat" u 1:2 w l ls 2 title 'Total Dead ', "obsD".nn.".dat" u 2:3 with points ls 9

   set output "reff".nn.".eps"
   set size 1, 0.3
   set yrange [ 0.00000 : 2.0 ] noreverse nowriteback
   plot for [i=4:N] "Rens".nn."_1.dat" u 1:i w l ls 5,   "Rens".nn."_1.dat" u 1:2 w l ls 6 title 'Effective R'

   set output "case".nn.".eps"
   set size 1, 0.7
   set yrange [ 0.00000 : * ] noreverse nowriteback
   plot for [i=4:N] "case".nn."_1.dat" u 1:i w l ls 7,   "case".nn."_1.dat" u 1:2 w l ls 8 title 'Total cases',\
        for [i=4:N] "active".nn."_1.dat" u 1:i w l ls 10,   "active".nn."_1.dat" u 1:2 w l ls 11 title 'Active cases'

   set output "susc".nn.".eps"
   set size 1, 0.7
   set yrange [ 0.00000 : * ] noreverse nowriteback
   plot for [i=4:N] "susc".nn."_1.dat" u 1:i w l ls 7,   "susc".nn."_1.dat" u 1:2 w l ls 8 title 'Susceptible'
}
